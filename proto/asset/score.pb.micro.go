...
func (c *scoreService) GetByOwner(ctx context.Context, in *RequestInfo, opts ...client.CallOption) (*ReplyScoreList, error) {
	req := c.c.NewRequest(c.name, "ScoreService.GetByOwner", in)
...
func (c *scoreService) UpdateByFilter(ctx context.Context, in *RequestUpdate, opts ...client.CallOption) (*ReplyInfo, error) {
...
func (h *scoreServiceHandler) GetByOwner(ctx context.Context, in *RequestInfo, out *ReplyScoreList) error {
	return h.ScoreServiceHandler.GetByOwner(ctx, in, out)
}

func (h *scoreServiceHandler) UpdateByFilter(ctx context.Context, in *RequestUpdate, out *ReplyInfo) error {
