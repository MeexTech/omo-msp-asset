...
func (c *assetService) GetToken(ctx context.Context, in *RequestInfo, opts ...client.CallOption) (*ReplyAssetToken, error) {
	req := c.c.NewRequest(c.name, "AssetService.GetToken", in)
	out := new(ReplyAssetToken)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *assetService) UpdateMeta(ctx context.Context, in *ReqAssetFlag, opts ...client.CallOption) (*ReplyInfo, error) {
	req := c.c.NewRequest(c.name, "AssetService.UpdateMeta", in)
	out := new(ReplyInfo)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *assetService) UpdateWeight(ctx context.Context, in *ReqAssetWeight, opts ...client.CallOption) (*ReplyInfo, error) {
	req := c.c.NewRequest(c.name, "AssetService.UpdateWeight", in)
	out := new(ReplyInfo)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (h *assetServiceHandler) UpdateMeta(ctx context.Context, in *ReqAssetFlag, out *ReplyInfo) error {
	return h.AssetServiceHandler.UpdateMeta(ctx, in, out)
}
